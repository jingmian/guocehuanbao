$(function () {
    var applyListOpt = {
        ...
        columns:[[
            ...
            {field:'carNum',title:'车牌号',width:150,align:'center',formatter:function(value,row,index){
            ...
            {field:'oilConsume',title:'油耗(L)',width:100,align:'right'/*,formatter:function(value,row,index){
            ...
            {field:'alarmEndTime1',title:'',width:300,align:'left'}
        ]],
        singleSelect:false,
        collapsible:true,
        SelectonSelect:true,
